...
//  Matematrics
//
//  Created by William Tempone on 10/01/15.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.tempsgames.coredataapp" in the application's documents Application Support directory.
